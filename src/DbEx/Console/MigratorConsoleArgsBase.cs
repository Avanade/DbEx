...
namespace DbEx.Console
{
    ...
    /// </summary>
    public abstract class MigratorConsoleArgsBase : OnRamp.CodeGeneratorDbArgsBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="Migration.Data.DataParserArgs"/>.
        /// </summary>
        ...
        /// <returns>The current <see cref="MigratorConsoleArgsBase"/> instance to support fluent-style method-chaining.</returns>
        ...
        /// </summary>
        /// <param name="args">The <see cref="MigratorConsoleArgsBase{TSelf}"/> to copy from.</param>
        protected void CopyFrom(MigratorConsoleArgsBase args)
        {
